...
- Production component execution and physical network residual construction
  (Block 15A/15B+). Phase 14A's callback adapters, Phase 14B's declarative
  ...
  harness, Phase 14F's component-like provider adapter, and Phase 14G's static
  inspection API have no dedicated runnable example in this guide.
- Parallel evaporators, valves, manifolds, recuperators, pre/post-heaters (Block 15C+).
